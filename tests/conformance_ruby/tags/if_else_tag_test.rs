...
#[test]
fn test_if_or() {
    assert_template_result!(" YES ", "{% if a or b %} YES {% endif %}", v!({"a": true, "b": true}));
    assert_template_result!(" YES ", "{% if a or b %} YES {% endif %}", v!({"a": true, "b": false}));
    assert_template_result!(" YES ", "{% if a or b %} YES {% endif %}", v!({"a": false, "b": true}));
    assert_template_result!("",      "{% if a or b %} YES {% endif %}", v!({"a": false, "b": false}));

    assert_template_result!(" YES ", "{% if a or b or c %} YES {% endif %}", v!({"a": false, "b": false, "c": true}));
    assert_template_result!("",      "{% if a or b or c %} YES {% endif %}", v!({"a": false, "b": false, "c": false}));
}

#[test]
fn test_if_or_with_operators() {
    assert_template_result!(" YES ", "{% if a == true or b == true %} YES {% endif %}", v!({"a": true, "b": true}));
    assert_template_result!(" YES ", "{% if a == true or b == false %} YES {% endif %}", v!({"a": true, "b": true}));
    assert_template_result!("", "{% if a == false or b == false %} YES {% endif %}", v!({"a": true, "b": true}));
}
...
fn test_if_from_variable() {
    ...
    assert_template_result!("", "{% if foo.bar %} NO {% endif %}", v!({"foo": { "bar": false }}));
    assert_template_result!("", "{% if foo.bar %} NO {% endif %}", v!({"foo": {}}));
    ...
    assert_template_result!(" YES ", "{% if foo.bar %} YES {% endif %}", v!({"foo": { "bar": true }}));
    assert_template_result!(" YES ", "{% if foo.bar %} YES {% endif %}", v!({"foo": { "bar": "text" }}));
    assert_template_result!(" YES ", "{% if foo.bar %} YES {% endif %}", v!({"foo": { "bar": 1 }}));
    assert_template_result!(" YES ", "{% if foo.bar %} YES {% endif %}", v!({"foo": { "bar": {} }}));
    assert_template_result!(" YES ", "{% if foo.bar %} YES {% endif %}", v!({"foo": { "bar": [] }}));

    assert_template_result!(" YES ", "{% if var %} NO {% else %} YES {% endif %}", v!({"var": false}));
    assert_template_result!(" YES ", "{% if var %} NO {% else %} YES {% endif %}", v!({"var": nil}));
    assert_template_result!(" YES ", "{% if var %} YES {% else %} NO {% endif %}", v!({"var": true}));
    assert_template_result!(" YES ", r#"{% if "foo" %} YES {% else %} NO {% endif %}"#, v!({"var": "text"}));

    assert_template_result!(" YES ", "{% if foo.bar %} NO {% else %} YES {% endif %}", v!({"foo": { "bar": false }}));
    assert_template_result!(" YES ", "{% if foo.bar %} YES {% else %} NO {% endif %}", v!({"foo": { "bar": true }}));
    assert_template_result!(" YES ", "{% if foo.bar %} YES {% else %} NO {% endif %}", v!({"foo": { "bar": "text" }}));
    assert_template_result!(" YES ", "{% if foo.bar %} NO {% else %} YES {% endif %}", v!({"foo": { "notbar": true }}));
    assert_template_result!(" YES ", "{% if foo.bar %} NO {% else %} YES {% endif %}", v!({"foo": {}}));
    assert_template_result!(" YES ", "{% if foo.bar %} NO {% else %} YES {% endif %}", v!({"notfoo": { "bar": true }}));
}
