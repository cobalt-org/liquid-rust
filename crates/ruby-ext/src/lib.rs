...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    ext.define_class("RenderSessionRef", ruby.class_object())?;
    ...
    ext.define_singleton_method(
        "ext_render_strict",
        function!(template::ext_render_strict, 2),
    )?;
    ext.define_singleton_method(
        "ext_template_root",
        function!(template::ext_template_root, 1),
    )?;
    ext.define_singleton_method(
        "ext_template_errors",
        function!(template::ext_template_errors, 1),
    )?;
    ext.define_singleton_method(
        "ext_template_warnings",
        function!(template::ext_template_warnings, 1),
    )?;
    ext.define_singleton_method(
        "ext_debug_payload",
        function!(template::ext_debug_payload, 1),
    )?;

    ext.define_singleton_method("ext_context_new", function!(context::ext_context_new, 4))?;
    ...
    ext.define_singleton_method(
        "ext_context_find_live_root",
        function!(context::ext_context_find_live_root, 2),
    )?;
    ext.define_singleton_method(
        "ext_context_has_live_root",
        function!(context::ext_context_has_live_root, 2),
    )?;
    ext.define_singleton_method(
        "ext_context_live_depth",
        function!(context::ext_context_live_depth, 1),
    )?;
    ext.define_singleton_method(
        "ext_context_has_key",
        function!(context::ext_context_has_key, 2),
    )?;
    ...
    ext.define_singleton_method(
        "ext_env_default",
        function!(environment::ext_env_default, 0),
    )?;
    ext.define_singleton_method("ext_env_build", function!(environment::ext_env_build, 1))?;
    ext.define_singleton_method(
        "ext_env_register_tag",
        function!(environment::ext_env_register_tag, 3),
    )?;
    ext.define_singleton_method(
